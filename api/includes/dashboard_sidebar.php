<div class="profile-card-section card">
    <div class="p-4">
        <div class="flex items-center gap-3">
            <div class="size-12 flex items-center justify-center rounded-lg" style="position:relative;">
                <img src="<?php echo htmlspecialchars($activeAvatarImage); ?>" alt="Avatar" style="width:100%; height:100%; object-fit:contain; border-radius:8px;">
                <div style="position:absolute; bottom:-3px; right:-3px; width:12px; height:12px; background:#10b981; border:2px solid #0d1015; border-radius:50%; z-index:10; box-shadow: 0 0 0 1px rgba(255,255,255,0.05);"></div>
            </div>
            <div class="flex-1">
                <div class="text-2xl font-display" style="font-size: 1.125rem; font-family: 'Rebels', monospace; font-weight: 700; color: white;"><?php echo htmlspecialchars($userName ?? ''); ?></div>
                <div class="text-xs uppercase text-muted-foreground" style="font-size: 0.75rem;"><?php echo htmlspecialchars($course ?? ''); ?></div>
            </div>
        </div>
    </div>
</div>

<div class="card" style="flex: 1; height: auto;">
    <div class="p-3">
        <div class="nav-section" style="display: flex; flex-direction: column;">
            ...
            <a href="lab.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'lab.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <a href="ourcourse.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'ourcourse.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor">
            ...
            <a href="course_video.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'course_video.php' ? 'active' : '' ?>">
                ...
                <span class="nav-label">Course Video</span>
            </a>
            <a href="assignment.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'assignment.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor">
            ...
            <a href="leaderboard.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'leaderboard.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <a href="teams.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'teams.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="tournament.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'tournament.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="contactus.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'contactus.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <a href="https://dragotool.shop/" class="nav-item" target="_blank" rel="noopener noreferrer">
            ...
            <a href="eaglone_shop.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'eaglone_shop.php' ? 'active' : '' ?>">
                <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
                ...
                <span class="nav-label">Eaglone shop</span>
            </a>
            <a href="download.php" class="nav-item" target="_blank" rel="noopener noreferrer">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polygon points="12 2 2 7 12 12 22 7 12 2"></polygon>
                    <polyline points="2 17 12 22 22 17"></polyline>
                    <polyline points="2 12 12 17 22 12"></polyline>
                </svg>
                <span class="nav-label">Eaglone IDE</span>
            </a>
