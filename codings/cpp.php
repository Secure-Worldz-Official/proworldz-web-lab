...
async function validateTask(code, output) {
    ...
    if (passed) {
        ...
        if (el) el.innerHTML += `\n<span class="output-error">✗ Validation failed: Please implement the core function correctly for this language. Live validation for this language is simulated on free hosting.</span>`;
    }
}
